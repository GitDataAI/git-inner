use crate::rpc::gitfs::{
    RepositoryInfoRequest, RepositoryInitRequest, RepositoryInitResponse, RpcRepository,
};
...
impl crate::rpc::gitfs::repository_service_server::RepositoryService for RpcServiceCore {
    async fn init(
        &self,
        request: Request<RepositoryInitRequest>,
    ) -> Result<Response<RepositoryInitResponse>, Status> {
        self.app
            .init_repository(request.into_inner())
            .await
    ...
    async fn set_public(
        &self,
        request: Request<RpcRepository>,
    ) -> Result<Response<RpcRepository>, Status> {
        self.app
