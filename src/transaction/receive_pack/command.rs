...
mod tests {
    ...
    fn test_from_pkt_line_create_command() {
        // 创建引用命令的pkt-line格式: 006c0000000000000000000000000000000000000000 cdfdb42577e2506715f8cfeacdbabc092bf63e8d refs/heads/experiment
        // 实际测试数据应该包含完整的pkt-line格式，包括长度前缀
        // 修复长度为006b (107字节)
    ...
    fn test_from_pkt_line_update_command() {
        // 更新引用命令的pkt-line格式
        // 计算实际长度: ca82a6dff817ec66f44342007202690a93763949 15027957951b64cf874c3557a0f3547bd83b3ff6 refs/heads/master
        // 字符数: 40 + 1 + 40 + 1 + 17 = 99 字符
        // 加上长度前缀4个字节，总共需要长度值为103，即0067
    ...
    fn test_from_pkt_line_delete_command() {
        // 删除引用命令的pkt-line格式: 006c<sha> 0000000000000000000000000000000000000000 refs/heads/experiment
        // 修复长度为006b (107字节)
